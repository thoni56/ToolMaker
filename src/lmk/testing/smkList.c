...
static smkMsgs msg[] = {
    ...
    { "200   ", "license server: date expired" },
    { "201   ", "license server: no license available" },
    { "202   ", "license server: format error" },
    { "203   ", "license server: no contact" },
    { "204   ", "license server: license file missing" },
    { "205   ", "license server: illegal license key" },
    { "206   ", "license server: unknown error" },
    ...
    { "226   ", "old end of text symbol, converting to \"EndOfText\"" },
    { "227   ", "token name expected" },
    { "228   ", "old format, using \"main\" as scanner" },
    { "229   ", "scanner name expected" },
    { "230   ", "end of line expected" },
    { "231   ", "must be one character long" },
    { "232   ", "set not unique mapped" },
    ...
    { "252   ", "character %1 multiple defined in %2 set" },
