...
extern tmkScContext tmkScNew( /* SMVocScanner smScanner */ );
extern void tmkScDelete( /* SMContext smThis */ );
extern int tmkScSkip( /* SMContext smThis, int smLength */ );
extern int tmkScModify( /* SMContext smThis, unsigned char *smBuffer, int smLength */ );
extern int tmkScCopy( /* SMContext smThis, unsigned char *smBuffer, unsigned int smFrom, unsigned int smTo */ );
extern int tmkScMapCopy( /* SMContext smThis, unsigned char *smBuffer, unsigned int smFrom, unsigned int smTo */ );
...
extern int tmkScan( /* SMContext smThis, TMToken *smToken */ );
