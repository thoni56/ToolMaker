...
OptTabRec smkOptTab[] = {
  ...
  {SMKTARGET_OPT, STR_TMO, "target", "target <lang>", (unsigned) "ansi-c",
     "generate for target language <lang>"},
  {TMKTARGET_OPT, STR_TMO, "", "", (unsigned) "ansi-c",
     "set target language"},
#ifdef WIN32
  {SMKOS_OPT, STR_TMO, "os", "os <os>", (unsigned) "WIN32",
#else
  {SMKOS_OPT, STR_TMO, "os", "os <os>", (unsigned) "SunOS",
#endif
...
#endif
     "set target os"},
  {SMKPREFIX_OPT, BOOLSTR_TMO, "prefix", "prefix [<prefix>]", (unsigned) "sm",
  ...
  {SET_OPT, BOOLSTR_TMO, "set", "set <set>", (unsigned)"ISO8859_1", "select character set [use default]"},
  ...
  {SMT_OPT, STR_TMO, "", "smt <file>", (int)NULL, "write tables to <file> (if any)"},
  {TMK_OPT, STR_TMO, "", "tmk <file>", (int)NULL, "read common options from <file>"},
