 ...
 * SoftLab ab (c) 1991
 *
 * $Header: /Repository/ToolMaker/src/smk/dfa.c,v 1.1 2002/06/25 20:04:42 Thomas Nilsson Exp $
 *
 * $Log: dfa.c,v $
 * Revision 1.1  2002/06/25 20:04:42  Thomas Nilsson
 * Initial version of ToolMaker source import
 *
 * Revision 1.4  1997/01/22 12:23:52  thoni
 * Fixed a FMR (free memory read) error found by Purify in the algorithm
 * to free redundant nodes
 *
 * Revision 1.3  1993/04/30 12:32:43  tools
 * Adoption to ANSI-C completed.
 * Explicit register allocation removed.
 *
 * Revision 1.2  1993/04/23  11:01:55  tools
 * Updated to handle multiple vocabularies.
 * Accept rewritten to correctly handle screened tokens.
 *
 * Revision 1.1  1993/03/24  09:23:49  tools
 * Ursprunglig version av smk testsvit
 *
 * Revision 1.7  1991/12/11  13:00:32  tools
 * Not modified
 *
 * Revision 1.6  91/08/12  16:23:48  tools
 * Test if optExclude > -1 when packing DFA
 * 
 * Revision 1.5  1991/07/12  05:12:12  tools
 ...
 *
 * Revision 1.1  1991/01/10  13:36:09  tools
 * Initial revision
 *
 *
 */
