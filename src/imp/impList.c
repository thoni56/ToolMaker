...
static impMsgs msg[] = {
    ...
    { "216   ", "Output file \"%1\" already open for writing." },
    { "217   ", "Input file \"%1\" already open for writing." },
    { "218   ", "Unable to open input file \"%1\"." },
...
void impLogv(
  ...
  impLog(pos, ecode, sev, errorstring);
  free(errorstring);
}
