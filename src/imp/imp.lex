...
%% 
		...
		goto smContinue;
%%;
  '%%COMMENT'	= imp'COMMENT'	%% lexColumn=this->smColumn;PUSH(imp_main_Scanner);this->smScanner=imp_comment_Scanner; goto smContinue;%%;
  '%%--'	= imp'--'[\n];
  '%%--'	= imp'--'[^\n]* 
%% 
...
%%SCANNER imp NO AUTO %%VOCABULARY main %%RULES
...
%%SCANNER string NO AUTO %%VOCABULARY main %%RULES
...
%%SCANNER keep NO AUTO %%VOCABULARY main %%RULE
...
%%SCANNER comment NO AUTO %%VOCABULARY main %%SKIP
